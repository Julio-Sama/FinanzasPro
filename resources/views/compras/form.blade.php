            ...
            <select class="form-control custom-select" name="id_proveedor" id="id_proveedor">
                ...
                @foreach($proveedores as $proveedor)
                    <option value="{{ $proveedor->id_proveedor }}"
                            @if(old('id_proveedor', $compra->id_proveedor) == $proveedor->id_proveedor) selected @endif>{{ $proveedor->nom_proveedor }}</option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <select class="form-control custom-select" name="comprobante_compra" id="comprobante_compra">
                ...
                <option value="Consumidor final"
                        @if(old('comprobante_compra', $compra->comprobante_compra) == 'Consumidor final') selected @endif>Consumidor final
                </option>
                <option value="Crédito fiscal"
                        @if(old('comprobante_compra', $compra->comprobante_compra) == 'Crédito fiscal') selected @endif>Crédito fiscal
                </option>
            </select>
        ...
        <div class="form-group">
            ...
            <select class="form-control custom-select" name="condicion_pago_compra" id="condicion_pago_compra">
                ...
                <option value="Crédito"
                        @if(old('condicion_pago_compra', $compra->condicion_pago_compra) == 'Crédito') selected @endif>
                    Crédito
                </option>
                <option value="Contado"
                        @if(old('condicion_pago_compra', $compra->condicion_pago_compra) == 'Contado') selected @endif>
                    Contado
                </option>
            </select>
            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
        ...
        <div class="col-md-1">
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('cant_detalle_compra') is-invalid @enderror"
                       name="cant_detalle_compra"
                       min="1"
                       id="cant_detalle_compra"
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('precio_detalle_compra') is-invalid @enderror"
                       name="precio_detalle_compra"
                       placeholder="0.00"
                       id="precio_detalle_compra"
            ...
            <div class="card-body">
                <table class="table table-hover table-sm" id="tabla_productos">
                    ...
                    <tr>
                        ...
                        <td>Total</td>
                        @if($compra->id_compra == null) <td>Acciones</td> @endif
