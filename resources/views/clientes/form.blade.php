...
<div class="row @if($cliente->id_cliente != null) d-none @endif">
    ...
    <div class="custom-controls-stacked">
        <label class="custom-control custom-radio">
            <input type="radio" class="custom-control-input" name="tipo_cliente" value="Natural"
                   checked
                   id="check_natural">
        ...
        <label class="custom-control custom-radio">
            <input type="radio" class="custom-control-input" name="tipo_cliente" value="Jurídico"
                   @if(old('tipo_cliente', $cliente->tipo_cliente) == 'Jurídico') checked @endif
                   id="check_juridico">
...
<div class="row mt-2" id="natural">
    <div class="col-md-3 @if(old('tipo_cliente', $cliente->tipo_cliente) == 'Jurídico') d-none @endif" id="div_dui">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="dui_cliente" placeholder="00000000-0"
                   id="dui_cliente" @if($cliente->tipo_cliente == 'Jurídico') disabled @endif
    ...
    <div class="col-md-3 @if(old('tipo_cliente', $cliente->tipo_cliente) != 'Jurídico') d-none @endif" id="div_nit">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nit_cliente" placeholder="0000-000000-000-0"
                   id="nit_cliente"
                   value="{{ old('nit_cliente', $cliente->nit_cliente) }}">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('nom_cliente') is-invalid @enderror" name="nom_cliente"
                   id="nom_cliente"
                   placeholder="ej. Juan, Distribuidora las caras"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('tel_cliente') is-invalid @enderror" name="tel_cliente"
                   id="tel_cliente"
                   placeholder="0000-0000" value="{{ old('tel_cliente', $cliente->tel_cliente) }}">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control @error('dir_cliente') is-invalid @enderror" name="dir_cliente" rows="1"
                      id="dir_cliente"
                      placeholder="Ciudad / Calle / Barrio / Casa">{{ old('dir_cliente', $cliente->dir_cliente) }}</textarea>
            @error('dir_cliente')
            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                <div data-field="name" data-validator="notEmpty">{{ $message }}</div>
            </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="ingreso_cliente" placeholder="0.00"
                   id="ingreso_cliente"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="egreso_cliente" placeholder="0.00"
                   id="egreso_cliente"
    ...
    <div id="section_natural" class="row pe-0 @if(old('tipo_cliente', $cliente->tipo_cliente) == 'Jurídico') d-none @endif">
        ...
        <div class="col-md-6 ps-4 pe-0">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="lugar_trabajo_cliente"
                       id="lugar_trabajo_cliente"
