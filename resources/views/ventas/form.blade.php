    ...
    @if ($venta->id_venta != null)
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="id_venta" id="id_venta" value="{{ $venta->id_venta }}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control custom-select" name="id_cliente" id="id_cliente">
                ...
                @foreach ($clientes as $cliente)
                    <option value="{{ $cliente->id_cliente }}" @if (old('id_cliente', $venta->id_cliente) == $cliente->id_cliente) selected @endif>
                        {{ $cliente->nom_cliente }}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="form-control custom-select" name="comprobante_venta" id="comprobante_venta">
                <option value="">Seleccione...</option>
                <option value="Consumidor final" @if (old('comprobante_venta', $venta->comprobante_venta) == 'Consumidor final') selected @endif>Consumidor final
                </option>
                <option value="Crédito fiscal" @if (old('comprobante_venta', $venta->comprobante_venta) == 'Crédito fiscal') selected @endif>Crédito fiscal
                </option>
            </select>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="form-control custom-select" name="condicion_pago_venta" id="condicion_pago_venta">
                ...
                <option value="Contado" @if (old('condicion_pago_venta', $venta->condicion_pago_venta) == 'Contado') selected @endif>
                    Contado
                </option>

                <option value="Crédito" @if (old('condicion_pago_venta', $venta->condicion_pago_venta) == 'Crédito') selected @endif>
                    Crédito
                </option>
            </select>
            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control custom-select" name="id_producto" id="id_producto">
                    ...
                    @foreach ($productos as $producto)
                        <option value="{{ $producto->id_producto }}">{{ $producto->descrip_producto }} | Stock:
                            {{ $producto->stock_producto }}</option>
                    @endforeach
                </select>
        ...
        <div class="col-md-1">
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('cant_detalle_venta') is-invalid @enderror"
                    name="cant_detalle_venta" min="1" id="cant_detalle_venta"
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('precio_detalle_venta') is-invalid @enderror"
                    name="precio_detalle_venta" placeholder="0.00" id="precio_detalle_venta" readonly
