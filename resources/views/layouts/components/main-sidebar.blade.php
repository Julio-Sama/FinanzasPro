            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('index') }}"><i
                            class="side-menu__icon bx bx-home"></i><span class="side-menu__label">Inicio</span>
                    </a>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('clientes.index') }}"><i
                            class="side-menu__icon bx bx-user"></i><span class="side-menu__label">Clientes</span>
                    </a>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="javascript:void(0)"><i
                            class="side-menu__icon bx bx-box"></i><span class="side-menu__label">Inventario</span><i
                            class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li class="panel sidetab-menu">
                            <div class="">
                                <ul>
                                    <li><a href="{{ route('categorias.index') }}" class="slide-item"> Categorias</a>
                                    </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('compras.index') }}"><i
                            class="side-menu__icon bx bx-cart"></i><span class="side-menu__label">Compras</span>
                    </a>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('ventas.index') }}"><i
                            class="side-menu__icon bx bx-file"></i><span class="side-menu__label">Ventas</span>
                    </a>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                            class="side-menu__icon bx bx-buildings"></i><span class="side-menu__label">Activo
                            fijo</span>
                    ...
                    <ul class="slide-menu">
                        <li class="panel sidetab-menu">
                            <div>
                                <ul>
                                    <li><a href="{{ route('tipos.index') }}" class="slide-item">Tipo de activo</a></li>
                                    <li><a href="{{ route('activos.index') }}" class="slide-item">Activo</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                            class="side-menu__icon bx bx-group"></i><span class="side-menu__label">Usuarios</span>
                    </a>
                </li>
