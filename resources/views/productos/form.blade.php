...
<div class="row mt-2">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="form-control custom-select @error('id_categoria') is-invalid @enderror" name="id_categoria" id="id_categoria">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('precio_venta_producto') is-invalid @enderror" name="precio_venta_producto"
                   placeholder="0.00"
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('stock_producto') is-invalid @enderror" name="stock_producto"
                   placeholder="0"
                   readonly
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('stock_min_producto') is-invalid @enderror" name="stock_min_producto"
                   placeholder="0"
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('interes_producto') is-invalid @enderror" name="interes_producto"
                   placeholder="0.0000%"
